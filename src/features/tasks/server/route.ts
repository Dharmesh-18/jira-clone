...
const app = new Hono()
  ...
  .post(
    ...
    async (c) => {
      ...
      const hightestPostionTask = await databases.listDocuments(
        DATABASE_ID,
        TASKS_ID,
        [
      ...
      const newPostions =
        hightestPostionTask.documents.length > 0
          ? hightestPostionTask.documents[0].position + 1000
          : 1000;
